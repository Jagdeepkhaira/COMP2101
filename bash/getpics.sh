...
# make a picture directory if we don't have one - assumes we have a home directory
...
test -f ~/Pictures/pics.zip || weget -q -O ~/Pictures/Pics.zip http://zonzorp.net/pics.zip

# unpack the download zipfile if it is there, then delete the local copy of the zipfile
